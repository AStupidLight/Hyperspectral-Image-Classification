...
class TwoDNN(nn.Module):
    def __init__(self,band):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=band, out_channels=6, kernel_size=4, stride=1),
   ...
   # print("第{}轮开始".format(i+1))
    ...
    if (i + 1 == args.epoch):
        ...
        with torch.no_grad():
            ...
            utils.save_result(pree, height,width, total_pos_true, number_true, "2D-Pavia")
